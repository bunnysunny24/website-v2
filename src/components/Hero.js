...
const Hero = () => {
  return (
    <div className="relative min-h-screen bg-cover bg-center" style={{ backgroundImage: 'url("https://images3.alphacoders.com/139/13985.jpg")' }}>
      ...
      <div className="absolute bottom-0 left-0 w-full h-2 bg-white z-20"></div>

      {/* Content */}
      <div className="relative z-30 container mx-auto px-4 h-screen flex flex-col justify-center items-center text-center text-white">
